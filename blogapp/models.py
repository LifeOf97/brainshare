...
class Post(models.Model):
    ...
    slug = models.SlugField(
        _("Slug"), blank=True, null=True, max_length=255,
        help_text=_('This field is prepopulated with the title field')
    )
    concern = models.CharField(
        _("Concern"), max_length=200, default="",
        help_text=_('<p>What does this post talk about</p><p>E.G programming, politics..</p>')
    )
    banner = models.ImageField(
    ...
    banner_copyright_link = models.URLField(
        _("Copyright link"), max_length=255, default='',
        blank=True, null=True, help_text=_("Link to where this image was taken from")
    )
    ...
    image_copyright_link = models.URLField(
        _("Copyright link"), max_length=255, default='',
        blank=True, null=True, help_text=_("Link to where this image was taken from")
    )
    # to add list to post
    ...
    status = models.CharField(
        ...
        help_text=_("The status of the post, if published or drafted")
    )
