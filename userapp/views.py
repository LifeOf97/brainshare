...
class PasswordReset(PasswordResetView):
    ...
    # forms.py file in order to display an error for email
    # addresses that do not exist. And import the form.
...
class PasswordResetConfirm(PasswordResetConfirmView):
    ...
    success_url = 'userapp:reset-password-complete'


class PasswordResetComplete(PasswordResetCompleteView):
    # view to return template after successful password rest.
    template_name = 'accounts/resetcompelet.html'
